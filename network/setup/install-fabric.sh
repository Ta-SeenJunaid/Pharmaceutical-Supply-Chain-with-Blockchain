...
HOSTNAME=dsti-peer1.dsti.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=manufacturer1-peer1.manufacturer1.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=manufacturer2-peer1.manufacturer2.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=manufacturer3-peer1.manufacturer3.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=provider1-peer1.provider1.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=provider2-peer1.provider2.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=distributer1-peer1.distributer1.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=distributer2-peer1.distributer2.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=distributer3-peer1.distributer3.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=user-peer1.user.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=user-peer2.user.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=orderer.dsti.com
removehost $HOSTNAME            &> /dev/null
addhost $HOSTNAME
HOSTNAME=postgresql
removehost $HOSTNAME            &> /dev/null
